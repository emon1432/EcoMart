            ...
            <div class="header-element">
                <div class="horizontal-logo">
                    <a href="{{ route('dashboard') }}" class="header-logo">
                        <img src="{{ asset('admin') }}/images/brand-logos/desktop-logo.png" alt="logo"
                            class="desktop-logo">
                        <img src="{{ asset('admin') }}/images/brand-logos/toggle-logo.png" alt="logo"
                            class="toggle-logo">
                        <img src="{{ asset('admin') }}/images/brand-logos/desktop-dark.png" alt="logo"
                            class="desktop-dark">
                        <img src="{{ asset('admin') }}/images/brand-logos/toggle-dark.png" alt="logo"
                            class="toggle-dark">
                        <img src="{{ asset('admin') }}/images/brand-logos/desktop-white.png" alt="logo"
                            class="desktop-white">
                        <img src="{{ asset('admin') }}/images/brand-logos/toggle-white.png" alt="logo"
                            class="toggle-white">
                    </a>
                </div>
            </div>
        ...
        <div class="header-content-right">
            ...
            <div class="header-element notifications-dropdown">
                ...
                <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                                        ...
                                        <div class="simplebar-content" style="padding: 0px;">
                                            <li class="dropdown-item p-3">
                                                <div class="d-flex align-items-start">
                                                    <div class="pe-3">
                                                        <span class="avatar bg-pink rounded-3">
                                                            <i class="far fa-folder-open text-fixed-white fs-18"></i>
                                                        </span>
                                                    </div>
                                                    <div
                                            ...
                                            <li class="dropdown-item p-3">
                                                <div class="d-flex align-items-start">
                                                    <div class="pe-3">
                                                        <span class="avatar bg-purple rounded-3">
                                                            <i class="fab fa-delicious text-fixed-white fs-18"></i>
                                                        </span>
                                                    </div>
                                                    <div
                                                        class="flex-grow-1 d-flex align-items-center justify-content-between">
                                            ...
                                            <li class="dropdown-item p-3">
                                                <div class="d-flex align-items-start">
                                                    <div class="pe-3">
                                                        <span class="avatar bg-success rounded-3">
                                                            <i class="fa fa-cart-plus text-fixed-white fs-18"></i>
                                                        </span>
                                                    </div>
                                                    <div
                                                        class="flex-grow-1 d-flex align-items-center justify-content-between">
                                            ...
                                            <li class="dropdown-item p-3">
                                                <div class="d-flex align-items-start">
                                                    <div class="pe-3">
                                                        <span class="avatar bg-warning rounded-3">
                                                            <i class="far fa-envelope-open text-fixed-white fs-18"></i>
                                                        </span>
                                                    </div>
                                                    <div
                                                        class="flex-grow-1 d-flex align-items-center justify-content-between">
                                            ...
                                            <li class="dropdown-item p-3">
                                                <div class="d-flex align-items-start">
                                                    <div class="pe-3">
                                                        <span class="avatar bg-danger rounded-3">
                                                            <i class="fab fa-wpforms text-fixed-white fs-18"></i>
                                                        </span>
                                                    </div>
                                                    <div
                                                        class="flex-grow-1 d-flex align-items-center justify-content-between">
                                            ...
                                            <li class="dropdown-item p-3">
                                                <div class="d-flex align-items-start">
                                                    <div class="pe-3">
                                                        <span class="avatar bg-success rounded-3">
                                                            <i class="far fa-check-square text-fixed-white fs-18"></i>
                                                        </span>
                                                    </div>
                                                    <div
                                                        class="flex-grow-1 d-flex align-items-center justify-content-between">
                    ...
                    <div class="p-2 empty-header-item1 border-top">
                        <div class="d-grid">
                            <a href="notification.html" class="btn btn-primary btn-sm">
                                View All
                            </a>
                        </div>
                    </div>
            ...
            <div class="header-element">
                <a href="#" class="header-link dropdown-toggle" id="mainHeaderProfile"
                    ...
                    <div class="d-flex align-items-center">
                        <div class="me-sm-2 me-0">
                            <img src="{{ asset('admin') }}/images/faces/2.jpg" alt="img" width="32"
                ...
                <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end"
                    ...
                    <li>
                        <a class="dropdown-item d-flex border-bottom" href="profile.html">
                            <i class="far fa-user-circle fs-16 me-2 op-7"></i>
                            Profile
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex border-bottom" href="chat.html">
                            <i class="far fa-smile fs-16 me-2 op-7"></i>
                            Chat
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex border-bottom" href="mail.html">
                            <i class="far fa-envelope  fs-16 me-2 op-7"></i>
                            Inbox
                            <span class="badge bg-success-transparent ms-auto">25</span>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex border-bottom border-block-end" href="chat.html">
                            <i class="far fa-comment-dots fs-16 me-2 op-7"></i>
                            Messages
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex border-bottom" href="mail-settings.html">
                            <i class="far fa-sun fs-16 me-2 op-7"></i>
                            Settings
                        </a>
                    </li>
                    <li>
